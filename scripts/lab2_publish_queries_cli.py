...
Usage:
    uv run publish_queries_cli "How do I use window functions?"
    uv run publish_queries_cli                                    # Interactive mode
    uv run publish_queries_cli aws "How do I join tables?"        # Specify provider
    uv run publish_queries_cli azure "What is watermarking?"

Traditional Python:
    python scripts/lab2_publish_queries_cli.py
"""
