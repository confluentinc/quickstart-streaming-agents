...
from .common.credentials import load_or_create_credentials_file, load_credentials_json
from .common.terraform import get_project_root
from .common.terraform_runner import run_terraform_destroy
from .common.ui import prompt_choice
...
def main():
    """Main entry point for simple_destroy."""
