---
source_url: https://docs.confluent.io/confluent-cli/current/command-reference/flink/catalog/confluent_flink_catalog_delete.html
title: confluent flink catalog delete
hierarchy: ['confluent-cli', 'command-reference', 'catalog', 'confluent_flink_catalog_delete.html']
scraped_date: 2025-09-05T13:53:22.526395
---

# confluent flink catalog delete¶

## Description¶

Delete one or more Flink catalogs in Confluent Platform.
