---
source_url: https://docs.confluent.io/confluent-cli/current/command-reference/flink/application/confluent_flink_application_delete.html
title: confluent flink application delete
hierarchy: ['confluent-cli', 'command-reference', 'application', 'confluent_flink_application_delete.html']
scraped_date: 2025-09-05T13:53:09.564977
---

# confluent flink application delete¶

## Description¶

Delete one or more Flink applications.
...
## See Also¶
  ...
  * [confluent flink application](index.html#confluent-flink-application) \- Manage Flink applications.
