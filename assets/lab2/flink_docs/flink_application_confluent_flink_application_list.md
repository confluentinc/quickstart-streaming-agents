---
source_url: https://docs.confluent.io/confluent-cli/current/command-reference/flink/application/confluent_flink_application_list.html
title: confluent flink application list
hierarchy: ['confluent-cli', 'command-reference', 'application', 'confluent_flink_application_list.html']
scraped_date: 2025-09-05T13:53:13.832790
---

# confluent flink application list¶
