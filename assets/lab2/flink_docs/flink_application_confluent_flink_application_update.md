---
source_url: https://docs.confluent.io/confluent-cli/current/command-reference/flink/application/confluent_flink_application_update.html
title: confluent flink application update
hierarchy: ['confluent-cli', 'command-reference', 'application', 'confluent_flink_application_update.html']
scraped_date: 2025-09-05T13:53:16.126141
---

# confluent flink application update¶
