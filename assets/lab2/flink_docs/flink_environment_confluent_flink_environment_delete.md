---
source_url: https://docs.confluent.io/confluent-cli/current/command-reference/flink/environment/confluent_flink_environment_delete.html
title: confluent flink environment delete
hierarchy: ['confluent-cli', 'command-reference', 'environment', 'confluent_flink_environment_delete.html']
scraped_date: 2025-09-05T13:53:31.054178
---

# confluent flink environment delete¶

## Description¶

Delete one or more Flink environments.
